...
if __name__ == "__main__":
    ...
    search_space = {
            ...
            'procs': 16,
            'frames': 2e5,         
            'additional_info': 'RAY_sweep',
            'llm_rs': False,
            'epochs': tune.choice([4, 8, 16, 32]),
            'batch_size': tune.choice([256, 512, 1024]),
            'frames_per_proc': tune.grid_search([128, 256, 512, 1024]),
            'discount': tune.grid_search([0.99, 0.95]),
            'lr': tune.grid_search([0.001, 0.0001]),
            'gae_lambda': tune.grid_search([0.95, 0.99]),
            'entropy_coef': tune.choice([0.0001, 0.001]),
            'value_loss_coef': 0.5,
            'max_grad_norm': 0.5,
            'optim_eps': 1e-8,
            'optim_alpha': 0.99,
