...
class DoorKey6x6(EnvironmentConstraints):
    ...
    def feasible_actions(self, agent_pos, agent_dir, action_history):
        ...
        if self.seed == 0:
            if agent_pos[0]==1: # agent is in the second row
                    ...
                    if agent_dir == DIRECTION_DICT['right']:
                        for j in range(len(action_history)):
                            if action_history[j] == 'open door':
                                ...
                                break
                        actions.append('open door')
                    elif agent_dir == DIRECTION_DICT['down'] or agent_dir == DIRECTION_DICT['left']:
                        actions.append('move forward')
                elif agent_pos[1]==3:
                    if agent_dir == DIRECTION_DICT['right'] or agent_dir == DIRECTION_DICT['left']:
                        actions.append('move forward')
                ...
                if agent_pos[1]==1:
                    if agent_dir == DIRECTION_DICT['right'] or agent_dir == DIRECTION_DICT['down'] or agent_dir == DIRECTION_DICT['up']:
                        actions.append('move forward')
                elif agent_pos[1]==2:
                    if agent_dir == DIRECTION_DICT['down'] or agent_dir == DIRECTION_DICT['up'] or agent_dir == DIRECTION_DICT['left']:
                        actions.append('move forward')
                elif agent_pos[1]== 4:
                    if agent_dir == DIRECTION_DICT['up'] or agent_dir == DIRECTION_DICT['down']:
                        actions.append('move forward')
                    ...
                    if agent_dir == DIRECTION_DICT['up'] or agent_dir == DIRECTION_DICT['down']:
                        ...
                        for j in range(len(action_history)):
                            if action_history[j] == 'pickup key':
                                ...
                                break
                        actions.append('pickup key')
                elif agent_pos[1]==2 or agent_pos[1]==4:
                    if agent_dir == DIRECTION_DICT['up'] or agent_dir == DIRECTION_DICT['down']:
                        actions.append('move forward')
            elif agent_pos[0]==4: # agent is in the fifth row
                if agent_pos[1]==1:
                    if agent_dir == DIRECTION_DICT['up'] or agent_dir == DIRECTION_DICT['right']:
                        actions.append('move forward')
                elif agent_pos[1]==2:
                    if agent_dir == DIRECTION_DICT['left']:
                        actions.append('move forward')
                    elif agent_dir == DIRECTION_DICT['up']:
                        for j in range(len(action_history)):
                            if action_history[j] == 'pickup key':
                                actions.append('move forward')
                                break
