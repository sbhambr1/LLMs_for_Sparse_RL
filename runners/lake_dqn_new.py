"""
Adopted by the DQN implementation shared here:https://github.com/MehdiShahbazi/DQN-Frozenlake-Gymnasium/blob/master/DQN.py
"""
...
class Model_TrainTest:
    ...
    def plot_training(self, episode):
        ...
        if episode == self.max_episodes:
            plt.savefig('./runners/plots/reward/lake/reward_plot.png', format='png', dpi=600, bbox_inches='tight')
        plt.tight_layout()
        plt.grid(True)
        plt.show()
        plt.clf()
        ...
        # Only save as file if last episode
        if episode == self.max_episodes:
            plt.savefig('./runners/plots/loss/lake/loss_plot.png', format='png', dpi=600, bbox_inches='tight')
        plt.tight_layout()
        plt.grid(True)
        plt.show()        
...
if __name__ == '__main__':
    ...
    RL_hyperparams = {
        ...
        "RL_load_path"          : f'./runners/weights/lake/final_weights' + '_' + '3000' + '.pth',
        "save_path"             : f'./runners/weights/lake/final_weights',
        "save_interval"         : 500,
