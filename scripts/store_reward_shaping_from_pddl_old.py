...
parser.add_argument('--variation', type=int, default=2, help='Variation of the LM policy')
...
if __name__ == '__main__':
    ...
    # both_wood, process_wood, make_stick, make_plank
    reward_flags = [False, False, False, False]

    index_wood0, index_wood1, index_process_wood, index_stick, index_plank = -1, -1, -1, -1, -1

    for i, action in enumerate(plan):
        if 'get_wood0' in action:
            index_wood0 = i
        elif 'get_wood1' in action:
            index_wood1 = i
        elif action == '(get_processed_wood)':
    ...
    if index_wood0 != -1 and index_wood1 != -1:
        reward_flags[0] = True
        
    if index_process_wood != -1 and reward_flags[0] == True and index_wood0 < index_process_wood and index_wood1 < index_process_wood:
        reward_flags[1] = True
        
    if index_stick != -1 and index_stick > index_process_wood and reward_flags[1] == True:
        reward_flags[2] = True
        
    if index_plank != -1 and index_plank > index_process_wood and reward_flags[1] == True:
        reward_flags[3] = True
