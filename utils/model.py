...
from algorithms.model import RecurrentACModel
...
class ACModel(nn.Module, RecurrentACModel):
    def __init__(self, obs_space, action_space, use_memory=False, use_text=False, use_symbolic=False):
        super().__init__()
